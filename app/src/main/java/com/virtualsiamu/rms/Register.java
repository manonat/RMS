...
public class Register extends AppCompatActivity {
    ...
    public void clickSignUpRegis(View view) {
        ...
        if (nameIDString.equals("") || nameSurString.equals("") ||
            ...
            MyAlert myAlert = new MyAlert();
            myAlert.myDialog(this, R.drawable.doremon48,
                    "รหัสบุคลากรผิด", "ไม่มีรหัสนี้ในฐานข้อมูล กรุณากรอก รหัสบุคลากรใหม่");
    ...
    private boolean checkNameID(String nameIDString) {
        ...
        //false ==> nameid false   , true ==> nameid true
        ...
        for (int i=0;i<cursor.getCount();i++) {
            ...
            Log.d("26AugV3", "รหัสที่อ่านได้ ==>" + cursor.getColumnIndex(MyManage.column_CorrectID));
